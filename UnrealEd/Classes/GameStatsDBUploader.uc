...
private:
	...
	void UploadEvent(struct FGameEventHeader& GameEvent, struct FGameFloatEvent* GameEventData);
	void UploadEvent(struct FGameEventHeader& GameEvent, struct FGamePositionEvent* GameEventData);
	void UploadEvent(struct FGameEventHeader& GameEvent, struct FTeamIntEvent* GameEventData);
	void UploadEvent(struct FGameEventHeader& GameEvent, struct FTeamFloatEvent* GameEventData);
	void UploadEvent(struct FGameEventHeader& GameEvent, struct FTeamStringEvent* GameEventData);
